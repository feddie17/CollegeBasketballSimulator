    ...
    public class DataController
    {
        ...
        public static MatchupResult RunMatchup(string team1, string team2, int a2pt, int a3pt, int aturn, int afoul, GameSpeed simSpeed, string year, bool neutralGame)
        {
            ...
            while (timeLeft > 1200)
            {
                ...
                {
                    PosessionResult res = RunPossession(team1Model, team2Model, team1Score, team2Score, timeLeft, team1HasBall, shortPosession, team2Fouls, team1Fouls, waitTime);
                ...
                {
                    PosessionResult res = RunPossession(team2Model, team1Model, team2Score, team1Score, timeLeft, team1HasBall, shortPosession, team1Fouls, team2Fouls, waitTime);
